...
@Composable
fun RoundedButton(backgroundColor: Color,
                  labelColor: Color,
                  label: String,
    ...
    Button(enabled = enabled, onClick = { onClick() },
        ...
        if(isLoading) {
            Row(modifier = Modifier.fillMaxWidth().wrapContentHeight().padding(12.dp),
                ...
                Text(text = stringResource(id = R.string.loading), style = MaterialTheme.typography.labelMedium, color = Color.White)
            }
